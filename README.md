...
### Step 1. 
Add this to your project **podfile** `pod wibmoPay`.Minimum deployment target version for wibmoPay SDK is `9.0` and swift version `4.1` and wibmoPay SDK version is `0.1.6`.
### Step 2. 
