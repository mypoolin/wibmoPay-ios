...
### Step 1. 
#### Add this to your project **podfile** `pod wibmoPay`.Minimum deployment target version for wibmoPay SDK is `9.0` and swift version `4.1` and wibmoPay SDK version is `0.1.3`.
### Step 2. 
...
```
#### Note:
- buildEnv can either be .staging or .production depending on your choice.
- Based on the buildEnv, Base URL is set as below
- PRODUCTION URL https://pgupi.mypoolin.com/callback.
